...
wheelnav = function (divId, raphael, divWidth, divHeight) {
    ...
    this.titleFont = '100 12px Helvetica, Arial, sans-serif';
    this.titleAttr = null;
...
spreader = function (wheelnav) {
    ...
    if (this.wheelnav.spreaderEnable) {
        ...
        else { this.fontAttr = { font: '100 12px Impact, Helvetica, Arial, sans-serif' }; }
...
this.TriangleMarkerCustomization = function () {
    ...
    custom.arcBaseRadiusPercent = 0.55;
    custom.arcRadiusPercent = 0.49;
    custom.startRadiusPercent = 0;
    return custom;
};
...
this.TriangleMarker = function (helper, percent, custom) {
    ...
    var arcBaseRadius = helper.sliceRadius * custom.arcBaseRadiusPercent;
    var arcRadius = helper.sliceRadius * custom.arcRadiusPercent;
    var startAngle = helper.startAngle + helper.sliceAngle * 0.65;
    var endAngle = helper.startAngle + helper.sliceAngle * 0.35;
...
this.PieLineMarkerCustomization = function () {
    ...
    var custom = new markerPathCustomization();
    custom.arcBaseRadiusPercent = 0.95;
    custom.arcRadiusPercent = 1;
    custom.startRadiusPercent = 2;
